...
var ViewNotePage = /** @class */ (function () {
    ...
    ViewNotePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-view-note',template:/*ion-inline-start:"D:\Ionic\notes\src\pages\view-note\view-note.html"*/'<ion-header>\n  <ion-navbar>\n    <ion-title>view-note</ion-title>\n  </ion-navbar>\n</ion-header>\n<ion-content padding>\n  <ion-card>\n    <ion-card-content>\n      <ion-card-title>\n        {{ note.title }}\n      </ion-card-title>\n      <div class="note-date">{{ note.date }}</div>\n      <hr />\n      <div>{{ note.content }}</div>\n    </ion-card-content>\n  </ion-card>\n</ion-content>\n<ion-footer>\n  <button ion-button color="danger" block (click)="deleteNote(note.createDate)">\n    Delete\n  </button>\n</ion-footer>\n'/*ion-inline-end:"D:\Ionic\notes\src\pages\view-note\view-note.html"*/,
        }),
